 ...
 * This file demonstrates how to integrate Synthmind with a web frontend
 */

// For React/Vue/Angular applications
export class SynthmindClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new SynthmindClient(provider, contractAddress);
